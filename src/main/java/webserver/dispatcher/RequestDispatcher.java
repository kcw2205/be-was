...
public class RequestDispatcher {
    ...
    public RequestDispatcher(HttpResponseFactory httpResponseFactory, RequestInterceptor staticFileInterceptor, RequestHandlerMapping requestHandlerMapping) {
    ...
    public HttpResponse intercept(HttpRequest httpRequest) {
        RequestInterceptor interceptor = this.requestHandlerMapping
